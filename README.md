...
Ulvori is a release-ready MVP for an adaptive AI fitness coach. It helps busy people stay consistent by changing workouts around real-life constraints: time, energy, soreness, equipment, gym crowding, missed days, and weak points.
...
For the Ulvori onboarding, guided tutorial, and new-user checklist, run `supabase/user_fitness_profiles_migration.sql` if your Supabase project was created before this table existed. The full `supabase/schema.sql` also includes this table and RLS policies for fresh setups.
...
Ulvori is not medical advice. Users should consult a physician before starting an exercise program, especially with medical conditions or injuries. Users should stop exercising and seek care if they experience chest pain, severe dizziness, unusual shortness of breath, or injury symptoms.
